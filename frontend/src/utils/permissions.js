...
// Waybills
export function canCrudWaybill(user) { return hasRole(user, ROLES.ADMIN, ROLES.PURCHASING); }
export function canUpdateWaybillStatus(user) { return hasRole(user, ROLES.ADMIN, ROLES.PURCHASING); }
